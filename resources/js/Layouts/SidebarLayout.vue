...
<template>
    <div class="flex">
        <div
            class="sidebar h-screen bg-[#2B2B2B] pt-8 absolute md:static duration-300 flex flex-col text-white select-none"
            :class="{'w-72': open, 'w-20': !open, 'hidden': !open && isSmall, 'high-contrast-input':highContrast}"
        >
            <!--  burger icon  -->
            <div class="flex justify-end mr-5">

                <svg @click="openBar" xmlns="http://www.w3.org/2000/svg" :height="iconSize.height" viewBox="0 -960 960 960"
...
<!--                    todo: do these group and :class for every sidebar row-->
                    <SidebarRow class="group" icon="home_FILL0_wght400_GRAD0_opsz24.png" :text="$t('sidebar.home')" :show-text="open">
                ...
                <SidebarRow @click="sidemenu = !sidemenu; open = true" icon="construction_FILL0_wght400_GRAD0_opsz24.png" :text="$t('sidebar.tools')"
                            :show-text="open"
                            class="group"
                ...
                <SidebarRow class="group" icon="help_FILL0_wght400_GRAD0_opsz24.png" :text="$t('sidebar.help')" :show-text="open">
                    <template v-slot:icon>
                        <svg xmlns="http://www.w3.org/2000/svg" :height="iconSize.height" viewBox="0 -960 960 960"
                             :width="iconSize.width">
                            <path :fill="highContrast ? '#FFFF00FF' : iconColor" :class="{'group-hover:fill-black':highContrast}"
                ...
                <SidebarRow
                    @click="sidelang = !sidelang; open = true" class="group"
                    icon="language_FILL0_wght400_GRAD0_opsz24.png" :text="$t('sidebar.lang')" :show-text="open"
            ...
            <div id="bottom" class="flex-none">
                ...
                <SidebarRow icon="contrast_FILL0_wght400_GRAD0_opsz24.png" :text="$t('sidebar.contrast')"
                            :show-text="open" @click="changeContrast" class="group">
                    <template v-slot:icon>
                        <svg xmlns="http://www.w3.org/2000/svg" :height="iconSize.height" viewBox="0 -960 960 960"
                             :width="iconSize.width">
                            <path :fill="highContrast ? '#FFFF00FF' : iconColor" :class="{'group-hover:fill-black':highContrast}"
                ...
                <div class="relative flex justify-center" v-if="page.props.auth.user">
                    ...
                    <SidebarRow icon="account_circle_FILL0_wght400_GRAD0_opsz24.png" class="group"
                                ...
                                :show-text="open" @click="userDropDown = !userDropDown; open = true">
                        <template v-slot:icon>
                            <svg xmlns="http://www.w3.org/2000/svg" :height="iconSize.height" viewBox="0 -960 960 960"
                                 :width="iconSize.width">
                                <path :fill="highContrast ? '#FFFF00FF' : iconColor" :class="{'group-hover:fill-black':highContrast}"
                ...
                <div
                    ...
                    <SidebarRow icon="account_circle_FILL0_wght400_GRAD0_opsz24.png" :text="$t('sidebar.user')"
                                :show-text="open" class="group"
                                @click="userDropDown = !userDropDown;open = true">
                        <template v-slot:icon>
                            <svg xmlns="http://www.w3.org/2000/svg" :height="iconSize.height" viewBox="0 -960 960 960"
                                 :width="iconSize.width">
                                <path :fill="highContrast ? '#FFFF00FF' : iconColor" :class="{'group-hover:fill-black':highContrast}"
...
<!--burger icon for small screens-->
        <span class="absolute text-white text-4xl top-5 left-4 cursor-pointer" @click="openBar" v-if="!open && isSmall">
                <svg xmlns="http://www.w3.org/2000/svg" :height="iconSize.height" viewBox="0 -960 960 960"
...
.hover-fill:hover path{
    fill: #000000; /* Replace with the color you want on hover */
}
