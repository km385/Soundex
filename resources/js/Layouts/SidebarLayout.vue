...
<template >
    <div class="flex ">
        <div :class="{'w-48 transition-w duration-500': !isCollapsed, 'w-20 transition-w duration-500': isCollapsed}"
            ...
            <div class="flex mr-2 flex-none cursor-pointer" :class="{'justify-center' : isCollapsed, 'justify-end ' : !isCollapsed}">
<!--                burger icon-->
...
<!--                tools links section-->
                ...
                <SidebarRow icon="construction_FILL0_wght400_GRAD0_opsz24.png"  text="tools" :show-text="isCollapsed" @mouseenter="expandTools" @mouseleave="collapseTools"/>
...
<!--                user links section-->
        ...
        <div v-if="isToolsExpanded" class="w-48 bg-[#2D2D30] text-white absolute left-48 top-20" @mouseenter="mouseOverToolsEnter" @mouseleave="mouseOverToolsLeave">
<!--            expanded tools-->
            <ul>
                ...
                <li class="hover:bg-gray-500 cursor-pointer">
                    <Link href="/speedup">SpeedUp</Link>
                </li>
                ...
                <li class="hover:bg-gray-500 cursor-pointer">
                    <Link href="/layermixer">LayerMix</Link>
                </li>
