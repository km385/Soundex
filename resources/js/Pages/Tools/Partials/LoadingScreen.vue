...
<template>
    ...
    <div class="bg-gray-800 flex justify-center items-center h-screen z-50 ">
        <svg class="icon-path" xmlns="http://www.w3.org/2000/svg" height="200" viewBox="0 -960 960 960" width="200">
            <path
